...
const pessoasConectadas = (dados.total_pessoas_ conectadas) / 1e9
...
<span>${pessoaNosMundo} bilhões</span> de pessoas e
que aproximadamente <span>${pessoasConectadas} bilhões </span> estão conectadas em alguma rede
